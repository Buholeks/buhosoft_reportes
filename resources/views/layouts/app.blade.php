...
<header class="header" style="display: flex; justify-content: space-between;">
    ...
    <div style="display: flex; align-items: center;">
        ...
        <p style="margin-right: 30px;"><i class="fa-regular fa-building"></i> {{ $empresa ? $empresa->nom_empresa : 'N/A' }}</p>
    ...
    <div>
        ...
        <a href="#" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="d-flex align-items-center p-2 text-white text-decoration-none">
    ...
    <div class="content-wrapper">
        <nav class="sidebar text-white p-3" style="width: 13rem; height: calc(100vh - 5rem); overflow-y: auto;">
            <ul class="list-unstyled">
                <li>
                    <a href="#" class="d-flex align-items-center p-2 text-white text-decoration-none" data-bs-toggle="collapse" data-bs-target="#submenu-equipos">
                    ...
                    <ul id="submenu-equipos" class="collapse list-unstyled ps-4">
                        ...
                        <li>
                            <a href="{{ route('equipos.create') }}" class="d-flex align-items-center p-2 text-white text-decoration-none">
                        ...
                        <li>
                            <a href="{{ route('equipos.index') }}" class="d-flex align-items-center p-2 text-white text-decoration-none">
                                <i class="fa-solid fa-mobile"></i>
                ...
                @can('vista recarga')
                <li>
                    <a href="#" onclick="loadPage('precargas.php'); return false;" class="d-flex align-items-center p-2 text-white text-decoration-none">
                ...
                <li>
                    <a href="#" class="d-flex align-items-center p-2 text-white text-decoration-none" data-bs-toggle="collapse" data-bs-target="#submenu-garantia">
                        <i class="fa-solid fa-mobile"></i>
                    ...
                    <ul id="submenu-garantia" class="collapse list-unstyled ps-4">
                        @can('vista garantia')
                        <li>
                            <a href="{{ route('garantias.index') }}" class="d-flex align-items-center p-2 text-white text-decoration-none">
                ...
                @can('vista precio')
                <li>
                    <a href="{{ route('listadeprecios.index') }}" class="d-flex align-items-center p-2 text-white text-decoration-none">
                ...
                @endcan
                <li>
                    <a href="#" class="d-flex align-items-center p-2 text-white text-decoration-none" data-bs-toggle="collapse" data-bs-target="#submenu-configuracion">
                    ...
                    <ul id="submenu-configuracion" class="collapse list-unstyled ps-4">
                        @can('ver usuarios')
                        <li>
                            <a href="{{ route('usuarios.index') }}" class="d-flex align-items-center p-2 text-white text-decoration-none">
                        ...
                        @can('ver roles')
                        <li>
                            <a href="{{ route('roles.index') }}" class="d-flex align-items-center p-2 text-white text-decoration-none">
        ...
        <main class="main-content" style="height: calc(100vh - 5.2rem); overflow-y: auto;box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
            @yield('content')
        </main>
    </div>
