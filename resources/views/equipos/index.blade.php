...
<div class="container mt-2">
    ...
    <div class="row m-2">
        ...
        <form class="col-8" method="GET" action="{{ route('equipos.index') }}">
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="imei" class="form-control" placeholder="Ingrese el IMEI" value="{{ request('imei') }}">
            </div>
        </form>
        @endcan
        <div class="col-4">
            ...
            <div class="col-md-3">
                ...
                <button type="button" class="btn btn-warning" onclick="eliminarSeleccionados()">Eliminar Seleccionados</button>
            </div>
            @endcan
        </div>
    </div>
    ...
    <div class="table-responsive divtabla" style=" max-height: 500px;">
        <form style="padding: 0px; border:0;" method="POST" action="{{ route('equipos.seleccionados') }}" id="delete-form">
            @csrf
